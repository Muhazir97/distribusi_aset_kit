...
<h1>Edit Data Aset</h1>
 <hr>
   ...
   include 'koneksi.php';
  $id = $_GET['id'];
  $query = mysqli_query($koneksi,"select * from data_komputer where id = '$id'");
        ...
        <table>
            ...
            <tr>
                ...
                <td>
                    ...
                    <input  class="form-control" type="text" name="serial_number" value="<?php echo $data['serial_number'] ?>">
                </td>                   
            </tr>   
            <tr>
                <td>Merk</td>
                <td><input class="form-control" type="text" name="merk" value="<?php echo $data['merk'] ?>"></td>                    
            </tr>   
            <tr>
                <td>Type</td>
                <td><input class="form-control" type="text" name="type" value="<?php echo $data['type'] ?>"></td>                  
            </tr>
            <br> 
            <tr>   
