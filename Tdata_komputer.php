...
<div class="container">
  ...
  <hr>
  <form action="Tdata_komputer1.php" method="post" enctype="multipart/form-data">
            <div class="form-group"> <br>

              <div class="form-group">
                <label>Jenis Aset</label>
                 <input type="text" name="jenis_aset" placeholder="Jenis Aset" class="form-control" required></textarea>
            </div>

            <div class="form-group">
                <label>Serial Number</label>
                 <input type="text" name="serial_number" placeholder="Serial Number" class="form-control" required></textarea>
            </div>
            ...
            <div class="form-group">
                <label>Type</label>
                <textarea type="textarea" name="type" placeholder="Type" class="form-control" required></textarea>
            </div>
...
<br>
                           ...
                           <form  action="tables2.php" method="get" >
  
                         <input type="submit" value="Kembali ke Data Aset">
                         </form>
      <!-- End of Main Content -->
