...
$sql = "SELECT * FROM data_komputer WHERE serial_number='$_POST[serial_number]'";
  $query = mysqli_query($koneksi, $sql) or die (mysqli_error());
 
  if(mysqli_num_rows($query) > 0){
    
    echo 'Gagal Menambahkan Data ! <br> Maaf Serial Number Sudah Ada Boss !';
 
  } else {

 
        
            if(!$insert = mysqli_query($koneksi, "INSERT INTO data_komputer VALUES(NULL,'$jenis_aset','$serial_number','$merk','$type')")){
    ...
    <h1 align="center">Data Aset</h1>
        ...
        <align><center> <a href="tables2.php" class="btn btn-sm btn-primary">KEMBALI KE DATA ASET</a></center></align>
</body>
        <!-- /.container-fluid -->
