...
<div class="container">
  ...
  <hr>
  <form action="Tdata_peminjam.php" method="post" enctype="multipart/form-data">
        ...
        <select  style="width:20%" name="jenis_aset1" >
          <option value="">--- Pilih Jenis Aset ---</option>
         <?php
         $koneksi=new mysqli ("localhost","root","","distribusi_aset");
         $result = mysqli_query($koneksi,"SELECT * FROM data_komputer ORDER BY id");
         while($row = mysqli_fetch_assoc($result))
          {
         echo "<option>$row[jenis_aset]</option>";
         } 
         ?>
         </select>

        <label>Serial Number :</label>
        <select  style="width:20%"  name="serial_number1" >
         ...
         ?>
          ...
          <label>Jenis Aset :</label>
        <select  style="width:20%" name="jenis_aset2" >
          <option value="">--- Pilih Jenis Aset ---</option>
         <?php
        $koneksi=new mysqli ("localhost","root","","distribusi_aset");
         $result = mysqli_query($koneksi,"SELECT * FROM data_komputer ORDER BY id");
         ...
         ?>
                ...
                <label>Serial Number :</label>
                 <select  style="width:20%"  name="serial_number2" >
          <option value="">-- Pilih Serial Number --</option>
         <?php
         $koneksi=new mysqli ("localhost","root","","distribusi_aset");
         $result = mysqli_query($koneksi,"SELECT * FROM data_komputer ORDER BY id");
         ...
         ?>
          ...
          <label>Jenis Aset :</label>
         <select  style="width:20%" name="jenis_aset3" >
          <option value="">--- Pilih Jenis Aset ---</option>
         <?php
        $koneksi=new mysqli ("localhost","root","","distribusi_aset");
         $result = mysqli_query($koneksi,"SELECT * FROM data_komputer ORDER BY id");
         ...
         ?>
                ...
                <label>Serial Number :</label>
                <select  style="width:20%"  name="serial_number3" >
          <option value="">-- Pilih Serial Number --</option>
         <?php
        $koneksi=new mysqli ("localhost","root","","distribusi_aset");
         $result = mysqli_query($koneksi,"SELECT * FROM data_komputer ORDER BY id");
...
<div>
             ...
             <label>Jenis Aset :</label>
          <select  style="width:20%" name="jenis_aset4" >
          <option value="">--- Pilih Jenis Aset ---</option>
         <?php
        $koneksi=new mysqli ("localhost","root","","distribusi_aset");
         $result = mysqli_query($koneksi,"SELECT * FROM data_komputer ORDER BY id");
         ...
         ?>
                ...
                <label>Serial Number :</label>
                <select  style="width:20%"  name="serial_number4" >
          <option value="">-- Pilih Serial Number --</option>
         <?php
      $koneksi=new mysqli ("localhost","root","","distribusi_aset");
         $result = mysqli_query($koneksi,"SELECT * FROM data_komputer ORDER BY id");
