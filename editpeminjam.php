...
<h1>Edit Data Peminjam</h1>
 <hr>
  ...
  include 'koneksi.php';
  $id = $_GET['id'];
  $query = mysqli_query($koneksi,"select * from data_peminjam where id='$id'");
  while($data = mysqli_fetch_array($query)){
    
    ?>
    <form action="updatepeminjam.php" method="post" enctype="multipart/form-data">        
        <table>
            <tr>
                <td>Nama Peminjam</td>
                <td>
            ...
            <tr>
                <td>Divisi</td>
                <td><input class="form-control" type="text" name="divisi" value="<?php echo $data['divisi'] ?>"></td>                  
            </tr>  
             <tr>
                <td>Tgl Peminjaman</td>
                <td><input class="form-control" type="date" name="tgl_peminjaman" value="<?php echo $data['tgl_peminjaman'] ?>"></td>                  
            </tr> 
             <tr>
                <td>Tgl Pengembalian</td>
                <td><input class="form-control" type="date" name="tgl_pengembalian" value="<?php echo $data['tgl_pengembalian'] ?>"></td>                  
            </tr>  
            <tr>
                <td>Jenis Aset</td>
                <td><input class="form-control" type="text" name="jenis_aset" value="<?php echo $data['jenis_aset'] ?>"></td>                  
            </tr> 
            <tr>
                <td>Serial Number</td>
                <td><input class="form-control" type="text" name="serial_number" value="<?php echo $data['serial_number'] ?>"></td>                  
            </tr>
            <tr>
                <td>Lokasi</td>
